...
import com.sjw.cache.utils.RedisUtil;
/**
 * Hash 和 list 的结合使用场景
 */
...
public class OrderListHashTest {
	...
	public void testAdd() {
		/*
		 * hmset order:1 orderId 1 money 36.6 time 2019-01-01 
		 * hmset order:2 orderId 2 money 38.6 time 2019-01-01 
		 * hmset order:3 orderId 3 money 39.6 time 2019-01-01
		 */
		Map<String, String> map = new HashMap<String, String>();
		map.put("orderId", "1");
		map.put("money", "36.6");
		map.put("time", "2019-01-03");
	...
	public void testGet() {
        //查询用户1所有订单的对应的键值
		List<Object> list = redisUtil.lrange("user:1:order", 0, -1);
