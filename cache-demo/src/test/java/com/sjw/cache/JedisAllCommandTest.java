...
public class JedisAllCommandTest {
	...
	public void pipeCompare() {
		Jedis redis = new Jedis("192.168.1.6", 6379);
...
//--------------------------------------------------------------------------------------------------
	...
	// 使用Lua操作Redis---入门   eval "return redis.call('get',KEYS[1])" 1 name
	@Test
	...
	public void testLuaFile() {
		...
		scriptBuffer.append("    return 1\n");
		scriptBuffer.append("end\n");
		// 存入Redis，redis会返回1个sha1值，具有唯一性，用于定位到此脚本
	...
	public void testLuaSha() {
		...
		jedis.auth("123456");
		// 计算sha值
		String scriptsha = "227b3382873751857c83d6ca25a679dd673a1e0b";
		Object result = jedis.evalsha(scriptsha, 1, "rate.limit:127.0.0.1", "10", "20");
		// 将操作结果打印出来
		System.out.println(result);
		// 断开连接，释放资源
	...
	// @Test
	public void ttt() {
		Jedis jedis = new Jedis("192.168.1.6", 6379, 2000, 2000, false, null, null, null);
		int i = 0;
		i = 9;
		jedis.connect();
		jedis.auth("123456");
